<form action="<?php bp_messages_form_action('compose') ?>" method="post" id="send_message_form" class="standard-form" role="main">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'framework') ?></label>
	...
	<label for="content"><?php _e( 'Message', 'framework') ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php _e( "Send Message", 'framework' ) ?>" name="send" id="send" />
	</div>
