...
/*-----------------------------------------------------------------------------------*/
    ...
    <div class="eleven columns alpha" style="margin: 40px 0;">

    <h2 class="bot-margin"><?php _e('What our lovely readers have said about it:', 'framework') ?></h2>
        
        <!--BEGIN .list-of-comments OUTPUT -->
		<ol class="list-of-comments eleven columns alpha omega">
        
        <?php wp_list_comments('type=comment&avatar_size=30&callback=zen_comment'); ?>
		...
		<ol class="pinglist">
			...
			<?php wp_list_comments('type=pings&callback=zen_list_pings'); ?>
...
/*-----------------------------------------------------------------------------------*/
    ...
    <div id="eleven columns top-margin no-bottom">
