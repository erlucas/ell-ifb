...
add_action( 'widgets_init', 'zen_video_widgets' );

function zen_video_widgets() {
	register_widget( 'zen_Video_Widget' );
}

class zen_video_widget extends WP_Widget {
...
function zen_Video_Widget() {

	$widget_ops = array(
		'classname' => 'zen_video_widget',
	...
	$control_ops = array(
		'width' => 220,
		'height' => 220,
		'id_base' => 'zen_video_widget'
	);

	$this->WP_Widget( 'zen_video_widget', __('Custom Video Widget', 'framework'), $widget_ops, $control_ops );
...
function widget( $args, $instance ) {
	...
	?>
		...
		<p class="zen_video_desc"><?php echo $desc ?></p>
