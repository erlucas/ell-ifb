...
add_action( 'widgets_init', 'zen_flickr_widgets' );

// Register widget
function zen_flickr_widgets() {
	register_widget( 'zen_Flickr_Widget' );
}

// Widget class
class zen_flickr_widget extends WP_Widget {
...
function zen_Flickr_Widget() {

	$widget_ops = array(
		'classname' => 'zen_flickr_widget',
		'description' => __('A widget that displays your Flickr photos.', 'framework')
	);

	$this->WP_Widget( 'zen_flickr_widget', __('Custom Flickr Photos', 'framework'), $widget_ops);
